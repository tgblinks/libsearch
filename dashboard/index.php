          ...
          <div class="">
            ...
            <div class="clearfix"></div>
             <div class="page-title">
              ...
              <div class="title_right" id="main">
                <div class="col-md-5 col-sm-5 col-xs-12 col-lg-12 form-group pull-right top_search">
                  <div class="input-group" id="content2" align="text-center">
                    <input type="search" id="searchbox" name="keyword" class="form-control" placeholder="Search for books...">
